          ...
          <div className="flex flex-col md:flex-row gap-6 items-center justify-between">
              ...
              {grades.map((grade) => (
                <button
                  ...
                  className={cn(
                    ...
                    selectedGrade === grade 
                      ? "bg-[#C4A862] text-white shadow-lg" 
            ...
            <div className="relative w-full md:w-64">
              ...
              <input 
                ...
                className="w-full pl-10 pr-4 py-2 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#C4A862]/20"
                value={searchQuery}
            ...
            filteredDocs.map((doc) => (
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="p-3 bg-[#FAF8F0] text-[#1B2A4A] rounded-xl group-hover:bg-[#B89200] group-hover:text-white transition-colors">
                    <FileText size={24} />
                  </div>
                  <div className="flex-grow">
                    ...
                    <button 
                      ...
                      className="flex items-center gap-2 text-[#1B2A4A] font-bold hover:underline"
                    >
