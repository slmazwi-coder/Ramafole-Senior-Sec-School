...
export const About = () => {
  ...
  const campusImageUrl = '/assets/about/rscampus.png';
  ...
  return (
    <div className="py-12 sm:py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Page Title */}
        <h1 className="section-title">About Ramafole SSS</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-stretch mb-16 sm:mb-24">
          ...
          >
            <div className="border-l-4 border-[#C4A862] pl-5 mb-6">
          ...
          <motion.div
            ...
            viewport={ { once: true } }
            className="bg-[#FAF8F0] rounded-3xl overflow-hidden shadow-lg border border-[#C4A862]"
          >
            <div className="bg-[#1B2A4A] p-6 sm:p-8">
              <div
                className="w-full rounded-3xl bg-[#1B2A4A] p-2 sm:p-3"
                style={ { border: '4px solid #C4A862' } }
              >
                <div className="w-full rounded-2xl overflow-hidden shadow-xl" style={ { aspectRatio: '4/3' } }>
                  {!campusFailed ? (
                    ...
                    <div className="w-full h-full bg-gradient-to-br from-[#1B2A4A] via-[#C4A862] to-[#1B2A4A] flex items-center justify-center">
        ...
        >
          ...
          <div className="bg-[#FAF8F0] rounded-3xl overflow-hidden shadow-lg border border-[#C4A862]">
            <div className="grid grid-cols-1 md:grid-cols-3">

              {/* Principal Photo Column */}
              <div className="flex flex-col items-center justify-center bg-[#1B2A4A] p-8 md:p-10">
                <div className="w-40 h-40 md:w-48 md:h-48 rounded-full overflow-hidden border-4 border-[#C4A862] shadow-xl mb-5">
                  {!principalFailed ? (
                    <img
                ...
                <p className="text-[#C4A862] text-sm font-semibold mt-1 text-center">
                  {data.principalTitle}
                </p>
              ...
              <div className="col-span-2 flex flex-col justify-center p-8 md:p-12">
                <div className="text-[#C4A862] text-6xl font-serif leading-none mb-2 opacity-40 select-none">
                  &ldquo;
                </div>
                ...
                <div className="text-[#C4A862] text-6xl font-serif leading-none mt-2 text-right opacity-40 select-none">
                  &rdquo;
                </div>
              </div>
