...
export const StudentPortal = () => {
  ...
  const studentNumber = useMemo(() => {
    return sessionStorage.getItem('ramafole_student_portal_student_number') || '';
  }, []);
  ...
  const logout = () => {
    sessionStorage.removeItem('ramafole_student_portal_student_number');
    navigate('/student/login');
  };

  return (
    <div className="min-h-screen bg-gray-50">
      <div className="bg-[#C4A862] text-white">
        ...
        <div className="flex flex-wrap gap-3 items-center justify-between mb-6">
          ...
          <div className="relative w-full sm:w-80">
            ...
            <input
              ...
              className="w-full bg-white border border-gray-200 rounded-xl pl-9 pr-3 py-2 text-sm outline-none focus:ring-2 focus:ring-[#C4A862]/20"
            />
          </div>
        </div>
