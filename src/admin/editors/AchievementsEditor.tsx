      ...
      <section className="bg-gray-800 border border-gray-700 rounded-2xl p-6 mb-6">
        <div className="flex items-center justify-between mb-6">
          ...
          <button
            ...
            className="flex items-center gap-2 bg-[#C4A862] text-white px-4 py-2 rounded-xl text-sm font-medium hover:bg-[#0F1A2E]"
          >
          ...
          <div className="bg-gray-700 rounded-xl p-4 mb-4 space-y-3">
            ...
            <div className="flex flex-wrap items-center justify-between gap-4 pt-2 border-t border-gray-600">
              <button 
                onClick={saveHall} 
                disabled={isScanning}
                className="flex items-center gap-2 bg-[#C4A862] text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-[#0F1A2E] disabled:opacity-50"
              >
                {isScanning ? (
